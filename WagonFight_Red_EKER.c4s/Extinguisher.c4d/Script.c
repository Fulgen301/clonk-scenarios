...
global func FxFireStart(object obj, int iNumber, iTemp, int iCausedBy, bool fBlasted, object pIncineratingObject)
{
...
global func FxIntExtinguisherStop(object obj, int iNumber, int iReason, fTemp)
{
	if (!fTemp) {
		// Zeit zum Löschen!
		Extinguish(obj);
...
global func FxFireStop(object obj, int iNumber, int iReason, fTemp)
{
	if (!fTemp) {
